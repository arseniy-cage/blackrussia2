...
import com.byreytiz.game.core.DialogClientSettings;
import com.byreytiz.game.gui.AutoShop;
import com.byreytiz.game.gui.HudManager;
import com.byreytiz.game.gui.BrDialogWindow;
import com.byreytiz.game.gui.Speedometer;
import com.byreytiz.game.gui.BrNotification;
import com.byreytiz.game.gui.Menu;
import com.byreytiz.game.gui.ChooseServer;
import com.byreytiz.game.gui.RadialMenu;
import com.byreytiz.game.gui.Donate;
import com.byreytiz.game.gui.models.Donatee;
import com.byreytiz.game.gui.reg.Reg;
import com.byreytiz.game.gui.PausMenu;
...
public abstract class NvEventQueueActivity
    ...
    private PausMenu mPausMenu = null;
...
public static void fixEditTextForAndroid10Xiaomi(EditText editText) {
    ...
    public void showPausMenu() { runOnUiThread(() -> { mPausMenu.Show(); }); }

    public void hidePausMenu() { runOnUiThread(() -> { mPausMenu.Hide(); }); }
    ...
    public void ShowPerson() { runOnUiThread(() -> { mReg.ShowPerson(); }); } // в низ к похожим
    ...
    public void setTurnState(int state) { runOnUiThread(() -> mSpeedometer.setTurnlight(state)); }
